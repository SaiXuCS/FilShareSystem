...
public class GroupClient extends Client implements GroupClientInterface {
	...
	public PublicKey exchangeKey(PublicKey publicKey, String username,byte[] aesKey){
		try{
			//System.out.println("\nOrignal Key:");
			//for(byte b: publicKey.getEncoded()) System.out.print(b);
			...
			message.addObject(encryptedKey.clone());
