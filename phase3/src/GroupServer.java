...
public class GroupServer extends Server {
	...
	public Hashtable<String, byte[]> secrets;	//  <username, W = H(p)>
	...
	public void start() throws NoSuchProviderException, NoSuchAlgorithmException {
		...
		try
		{
			...
			secrets = (Hashtable<String ,byte[]>)userStream.readObject();
		}
		catch(FileNotFoundException e)
		{
			...
			byte[] w = digest.digest(password.getBytes());		//generate shared secret w
