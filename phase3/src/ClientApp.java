...

{
	...
	public static void main(String [] args) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidAlgorithmParameterException, InvalidKeyException, NoSuchPaddingException, BadPaddingException, IllegalBlockSizeException, IOException, ClassNotFoundException

	{
		...
		String hostname_group = "localhost";
		String hostname_file= "localhost";
...

		{
			...
			w = digest.digest(password.getBytes(StandardCharsets.UTF_8));		//generate shared secret w
			...
			PublicKey publicKey = gclient.exchangeKey(dhPair.getPublic(),username,w);
			if(publicKey == null){
